...
\setboolean{shading}{true}
 ...
 {\MODULE} KnightsBridge}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
Four knights must cross a norrow bridge\.{\dots}
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 It is night, and they will need the light from
 \ensuremath{Archibald}\mbox{'}s torch to
 cross. Sadly, the bridge will hold only two knights at a time, and the
 torch will only burn for another fifteen minutes. Now,
 \ensuremath{Archibald} is
 quick and nimble, he can make it in just one minute. Baldur is strong
 and can make it in two minutes. Now \ensuremath{Charleston} is old and will
 need
 five minutes to cross. And lastly \ensuremath{David} is trimit and frail, he
 will
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
https:\ensuremath{\.{\slsl}twitter.com}/\ensuremath{MCLMouritzen}/status/1362929925083308032
\end{cpar}%
\end{lcom}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} {\EXTENDS} Integers ,\,
 FiniteSets}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} {\VARIABLES} Knights
 ,\,\@s{20.26}}%
\@y{\@s{0}%
 The set of knights
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{51.42} TorchSide
 ,\,\@s{10.52}}%
\@y{\@s{0}%
 The side of the river the torch is on
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{51.42}
 ElapsedTime\@s{4.09}}%
\@y{\@s{0}%
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
This is used for type checking (\ensuremath{TypeOk})
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} Side \.{\defeq} \{\@w{Near}
 ,\,\@w{Far} \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{Max(S)} returns the maximum element in a set (of numbers)
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} Max ( S ) \.{\defeq}
 {\CHOOSE} m \.{\in} S \.{:} ( \A\, n \.{\in} S \.{:} m \.{\geq} n )}%
\@pvspace{24.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} TypeOk \.{\defeq} \.{\land}
 \A\, k \.{\in} Knights \.{:} k . side \.{\in} Side\@s{4.1}}%
\@y{\@s{0}%
 Every knight must be on a side
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{52.67} \.{\land}
 TorchSide \.{\in} Side\@s{54.98}}%
\@y{\@s{0}%
 The torch must be on a side
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{52.67} \.{\land}
 ElapsedTime \.{\in} Nat}%
\@pvspace{24.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
- All knights start on the \ensuremath{Near} side
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
- Each knight takes a certain amount of time to cross (constant)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
- The torch starts on the \ensuremath{Near} side
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
- Time starts at zero
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} Init \.{\defeq} \.{\land}
 Knights \.{=} \{}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{63.21} [ side
 \.{\mapsto}\@w{Near} ,\, time \.{\mapsto} 1 ] ,\,\@s{4.1}}%
\@y{\@s{0}%
 Archibald
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{63.21} [ side
 \.{\mapsto}\@w{Near} ,\, time \.{\mapsto} 2 ] ,\,\@s{4.1}}%
\@y{\@s{0}%
 Baldur
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{63.21} [ side
 \.{\mapsto}\@w{Near} ,\, time \.{\mapsto} 5 ] ,\,\@s{4.1}}%
\@y{\@s{0}%
 Charleston
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{63.21} [ side
 \.{\mapsto}\@w{Near} ,\, time \.{\mapsto} 8 ]\@s{10.21}}%
\@y{\@s{0}%
 David
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{46.81} \}}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{35.70} \.{\land}
 TorchSide \.{=}\@w{Near}\@s{4.1}}%
\@y{\@s{0}%
 Torch starts on the \ensuremath{Near} side
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{35.70} \.{\land}
 ElapsedTime \.{=} 0\@s{16.03}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} NearToFar \.{\defeq}
 \.{\land} TorchSide \.{=}\@w{Near}}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{67.40} \.{\land} \E\,
 travelers \.{\in} {\SUBSET} Knights \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{82.61} \.{\land}
 Cardinality ( travelers ) \.{=} 1 \.{\lor} Cardinality ( travelers ) \.{=}
 2}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{82.61} \.{\land} \A\, k
 \.{\in} travelers \.{:} k . side \.{=}\@w{Near}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{82.61} \.{\land} Knights
 \.{'} \.{=} \{ {\IF} k \.{\in} travelers}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{149.18} \.{\THEN} [ k
 {\EXCEPT} {\bang} . side \.{=}\@w{Far} ]}%
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{149.18} \.{\ELSE} k}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}}\@s{149.18} \.{:} k \.{\in}
 Knights \}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{82.61} \.{\land}
 ElapsedTime \.{'} \.{=} ElapsedTime \.{+} Max ( \{ k . time \.{:} k \.{\in}
 travelers \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}}\@s{67.40} \.{\land}
 TorchSide \.{'} \.{=}\@w{Far}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}} FarToNear \.{\defeq}
 \.{\land} TorchSide \.{=}\@w{Far}}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{67.40} \.{\land} \E\,
 travelers \.{\in} {\SUBSET} Knights \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{82.61} \.{\land}
 Cardinality ( travelers ) \.{=} 1 \.{\lor} Cardinality ( travelers ) \.{=}
 2}%
 \@x{\makebox[0pt][r]{\scriptsize 90\hspace{1em}}\@s{82.61} \.{\land} \A\, k
 \.{\in} travelers \.{:} k . side \.{=}\@w{Far}}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}}\@s{82.61} \.{\land} Knights
 \.{'} \.{=} \{ {\IF} k \.{\in} travelers}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{149.18} \.{\THEN} [ k
 {\EXCEPT} {\bang} . side \.{=}\@w{Near} ]}%
\@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@s{149.18} \.{\ELSE} k}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{149.18} \.{:} k \.{\in}
 Knights \}}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{82.61} \.{\land}
 ElapsedTime \.{'} \.{=} ElapsedTime \.{+} Max ( \{ k . time \.{:} k \.{\in}
 travelers \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{67.40} \.{\land}
 TorchSide \.{'} \.{=}\@w{Near}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}} Next \.{\defeq} \.{\lor}
 NearToFar}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{39.83} \.{\lor}
 FarToNear}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ {\langle} Knights ,\, TorchSide ,\,
 ElapsedTime {\rangle}}}%
\@pvspace{16.0pt}%
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 By specifying \ensuremath{AllAcross \.{=} {\FALSE}} as invariant, the model
 checker will
 alert us to any execution traces that result in a solution.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}} AllAcross \.{\defeq}
 \.{\land} \A\, k \.{\in} Knights \.{:} k . side \.{=}\@w{Far}}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{61.02} \.{\land}
 ElapsedTime \.{\leq} 15}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Feb} 21
 21:57:08 \ensuremath{EST} 2021 by \ensuremath{johns
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Feb} 20 19:50:27
 \ensuremath{EST} 2021 by \ensuremath{johns
}%
\end{cpar}%
\end{lcom}%
\end{document}
